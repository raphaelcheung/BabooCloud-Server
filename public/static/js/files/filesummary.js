...
(function() {
	...
	FileSummary.prototype = {
		...
		update: function() {
			...
			$dirInfo.html(this.summary.totalDirs + ' 个文件夹');
			$fileInfo.html(this.summary.totalDirs + ' 个文件夹');
			$hiddenInfo.html(' (包含 ' +  this.summary.totalHidden + ' 个隐藏项目)');
			var fileSize = this.summary.sumIsPending ? '等候' : OC.Util.humanFileSize(this.summary.totalSize);
		...
		render: function() {
			...
			if (!isNaN(summary.totalSize)) {
				fileSize = summary.sumIsPending ? '等候' : OC.Util.humanFileSize(summary.totalSize);
